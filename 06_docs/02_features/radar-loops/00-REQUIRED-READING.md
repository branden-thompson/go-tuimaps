...
dispositioned, further rounds until reviewers converge; the D-17 specimen (OW-2); then the DISCOVER
report and HUM LEAD approval. The full gate takes about eighteen minutes; every run's time is in
