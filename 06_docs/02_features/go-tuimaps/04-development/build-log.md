...
**Next:** 00.4 to 00.6 (the rest of the test kit), 00.7 and 00.12 (the gate script), 00.8 and 00.11 (lint and the static checks). 00.13, the parity mapping, was written in PLAN.
