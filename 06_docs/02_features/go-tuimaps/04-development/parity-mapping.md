...
| How the owner was chosen | By the upstream source file each row was read from, then corrected by hand where a ruling moved the behaviour (P-05a, P-08, P-36). A work package that finds a row belongs elsewhere moves it here, in the same commit. |
...
| WP-04 assets | 1 |
| WP-06 tiles | 3 |
| WP-08 style and colour | 4 |
| WP-09 render | 33 |
| WP-12 public package | 6 |
| WP-13 app | 4 |
...
| P-24 | Draw order, z<2 | Extended | WP-09 render | `TestParityP24_DrawOrderZ2` |
...
| P-44 | Colour pick | Fix | WP-03 mvt decoder | `TestParityP44_ColourPick` |
| P-45 | Line width | Fix | WP-03 mvt decoder | `TestParityP45_LineWidth` |
...
| P-51 | Fetch failure | Extended | WP-09 render | `TestParityP51_FetchFailure` |
...
| P-61 | Marker id | Match | WP-09 render | `TestParityP61_MarkerId` |
