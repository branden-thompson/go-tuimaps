...
| 2 | An alert defined by a **zone shape** (900–14,000 vertices *in DISCOVER's three coastal samples; PLAN measured 47 to 527 for inland zones and 1,800 to 14,000 for Gulf-coast counties* — about nine alerts in ten), the place close to the edge | Inside or outside; which way the nearest edge lies |
