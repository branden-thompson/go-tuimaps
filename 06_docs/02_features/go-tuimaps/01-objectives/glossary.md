...
| **ID prefixes** | R- brief requirement · FR- / NFR- functional / non-functional requirement · CD- constraint or dependency · A- assumption · RS- risk · OQ- open question · AI- research report · S- specimen finding · P- parity row · E- extension row · L- ledger entry · X- contradiction between research reports · M- metric · D- ruling · Q- question for the human lead. |
