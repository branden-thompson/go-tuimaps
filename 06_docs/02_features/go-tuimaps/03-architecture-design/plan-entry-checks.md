...
| HUM LEAD's Linux machine — **Ghostty, with fish as its shell; JetBrains Mono** (D-109, D-110); the card has not been run here, and cannot be until the repository has a remote to pull from, at SHIP (D-111, D-19) | NOT RUN | NOT RUN | NOT RUN | NOT RUN | NOT RUN | NOT RUN | NOT RUN | NOT RUN | NOT RUN | NOT RUN |
