...
| The report (v0.2.0 WP-L5) | `Map.Report`, `Report`, `AlertShown`, `PlaceReport`, `PlaceAlert`, `Where` (`Inside`, `Outside`, `Nearby`), `Map.SetNearby` |
